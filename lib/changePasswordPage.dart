    ...
    return Dialog(
      ...
      child: Container(
        ...
        constraints: BoxConstraints(
          maxHeight: 0.8.sh, // Ensure the dialog doesn't exceed 80% of screen height
        ),
        child: Column(
...
void save_sms_concern() async {
  ...
  try{
    ...
    print('save_sms_consent body: ${response.body}');
    ...
    if (response == 'true') {
      ...
      print("Failed to fetch SMS consent status");
    }
  } catch (e) {
    print('Exception: $e');
  }
